...
impl Vec3 {
    ...
    /// L1 (Manhattan) norm
    #[inline]
    pub fn length_l1(self) -> f32 {
        self.x.abs() + self.y.abs() + self.z.abs()
    }

    /// L∞ (Chebyshev) norm
    #[inline]
    pub fn length_inf(self) -> f32 {
    ...
    pub fn normalize(self) -> Self {
        ...
        assert!(
            len > f32::EPSILON,
            "Vec3::normalize called on a zero (or near-zero) vector"
        );
        self / len
    }
...
impl Vec4 {
    ...
    pub fn normalize(self) -> Self {
        ...
        assert!(
            len > f32::EPSILON,
            "Vec4::normalize called on a zero (or near-zero) vector"
        );
        self / len
    }
